...
GPUTimer::GPUTimer(std::shared_ptr<GTDatabase> gtdb_, shared_ptr<TimingTorchRawDB> timing_raw_db_)
    : gtdb(*gtdb_),
      ...
      dmp_timing_output_thresholds(timing_raw_db.dmp_timing_output_thresholds.data_ptr<float>()),
      dmp_timing_slew_lower_thresholds(timing_raw_db.dmp_timing_slew_lower_thresholds.data_ptr<float>()),
      dmp_timing_slew_upper_thresholds(timing_raw_db.dmp_timing_slew_upper_thresholds.data_ptr<float>()),
      dmp_timing_slew_derates(timing_raw_db.dmp_timing_slew_derates.data_ptr<float>()),
      dmp_pin_input_thresholds(timing_raw_db.dmp_pin_input_thresholds.data_ptr<float>()),
      dmp_pin_slew_lower_thresholds(timing_raw_db.dmp_pin_slew_lower_thresholds.data_ptr<float>()),
      dmp_pin_slew_upper_thresholds(timing_raw_db.dmp_pin_slew_upper_thresholds.data_ptr<float>()),
      dmp_pin_slew_derates(timing_raw_db.dmp_pin_slew_derates.data_ptr<float>()),
